...
description: Adversarially reviews a finished research document draft. Four lenses
  ...
  phase of the research-pipeline workflow; invoke it directly when a draft already exists.
...
`.claude/workflows/research-pipeline.js` holds this procedure as phase 2, so the usual
